...
const BookingDetails = ({ navigation }) => {
	...
	return (
		<ScrollView contentContainerStyle={styles.container}>
			<Text style={styles.header}>Détails de la réservation</Text>
			{bookingDetails ? (
					...
					<View style={styles.cardItems}>
						...
						<View>
							<Text style={styles.modelName}>
								{vehicleDetails?.brand || 'Lexus ES 300h'}
								{vehicleDetails?.model || 'Lexus ES 300h'}
							</Text>
							<Text
								style={styles.dateFromTo}
							>{`${vehicleDetails?.price} cfa/jour`}</Text>
						</View>
					</View>
					<View style={styles.cardItems}>
						<View style={styles.profileImage}>
						...
						<View>
							...
							<Text style={styles.dateFromTo}>
								{formatBookingDate(bookingDetails.bookingDate)}
							</Text>
						</View>
					</View>
					<View style={styles.cardItems}>
						...
						<View>
							<Text style={styles.modelName}>Heure</Text>
							<Text style={styles.dateFromTo}>
								{formatBookingTime(bookingDetails.bookingDate)}
							</Text>
						</View>
					</View>

					{/* Client Details */}
					<Text style={styles.header}>Détails du client</Text>
					<View style={styles.cardItems}>
						<View
						...
						<View style={{ justifyContent: 'center' }}>
							<Text style={{ color: '#000', fontSize: 16 }}>
								{bookingDetails.fullName || 'Linda H.'}
							</Text>
						</View>
					</View>
					<View style={styles.cardItems}>
						...
						<View style={{ justifyContent: 'center' }}>
							<Text style={{ color: '#000', fontSize: 16 }}>
								{bookingDetails.phoneNumber || '415-555-5555'}
							</Text>
						</View>
					</View>
